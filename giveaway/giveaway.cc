...
{{$maxP := -1}}{{$maxW := 1}}{{$chan:= $giveawayChan}}{{$ID:= ""}}{{$dbData := sdict}}
...
{{$bc := joinStr " " "@everyone There is a new" $prize "giveaway!!"}}
{{sendMessageNoEscape $chan $bc}}
